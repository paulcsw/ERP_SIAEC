...
async def admin_users_page(
    ...
    return templates.TemplateResponse("admin/users.html", _ctx(
...
async def admin_reference_page(
    ...
    return templates.TemplateResponse("admin/reference.html", _ctx(
        request, current_user,
        page="reference",
        aircraft=aircraft,
...
async def admin_shops_page(
    ...
    return templates.TemplateResponse("admin/shops.html", _ctx(
        request, current_user,
        page="shops",
        shops=shops,
    ))
...
async def admin_shop_access_page(
    ...
    return templates.TemplateResponse("admin/shop_access.html", _ctx(
        request, current_user,
        page="shop_access",
