...
async def task_detail_page(
    ...
    audit_q = (
        ...
        .where(
            AuditLog.entity_type.in_(["task_item", "task_snapshot"]),
...
async def mobile_m3(
    ...
    if not snap:
        return templates.TemplateResponse("tasks/partials/_m2_tasks.html", {
            "request": request, "ac_reg": ac, "tasks": [], "status_filter": "",
            "workers": workers,
        })
...
async def mobile_m5(
    ...
    audit_rows = (await db.execute(
        ...
        .where(AuditLog.entity_type.in_(["task_item", "task_snapshot"]), AuditLog.entity_id == snap.task_id)
